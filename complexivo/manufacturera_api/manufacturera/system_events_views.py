...
from .mongo_serializers import ServiceEventSerializer
...
def system_events_list_create(request):
    ...
    serializer = ServiceEventSerializer(data=request.data)
...
def system_events_detail(request, id: str):
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = ServiceEventSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
